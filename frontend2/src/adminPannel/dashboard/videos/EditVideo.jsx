        ...
        <Dashboard>
            <div dir="rtl" className="max-w-4xl mx-auto px-4 py-10">
                <div className="flex items-start md:items-center justify-between mb-10 gap-4">
                    <div>
                        <h2 className="text-2xl md:text-3xl font-black text-slate-900 mb-2 border-b-4 border-indigo-500 pb-2 w-fit">ویرایش ویدیو</h2>
                ...
                <form onSubmit={formik.handleSubmit} className="space-y-8">
                    ...
                    <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-4">
                        ...
                        <button
                            type="submit"
                            className="bg-amber-500 hover:bg-amber-600 text-white px-12 py-4 rounded-[20px] font-black text-sm shadow-xl shadow-amber-100 transition-all hover:-translate-y-1 flex items-center justify-center gap-2 w-full sm:w-auto"
                        >
                            <FiEdit2 size={20} />
